        ...
        <div className="container d-flex justify-content-center align-items-center vh-100 text-white">
            <div className="text-center">
                <img
                    ...
                    style={{ maxWidth: '300px' }}
                />
                <h1 className="display-4" style={{ fontWeight: "600" }}>405 - Unauthorized</h1>
                <p className="lead" style={{ fontWeight: "600" }}>You Can't answer your own form</p>
