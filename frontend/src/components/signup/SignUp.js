    ...
    return (
        <div className="d-flex justify-content-center w-50 bg-white">
            <div style={{ width: "45%" }}>
                ...
                <div>
                    <p className="text-center" style={{ color: "black", fontSize: "14px", margin: "5px 0" }}>Don't have an account? <a href="/login" style={{ fontSize: "14px", marginLeft: "5px", color: "#2d79f3", fontWeight: "500", cursor: "pointer", textDecoration: "none" }}>Sign Up</a></p>
                </div>
            </div>
        </div>
    );
